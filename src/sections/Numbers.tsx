...
const Numbers = () => {
  ...
  return (
    <>
      {/* Desktop / 1440 */}
      <section className="relative z-10 mt-[-32px] mb-[8px] max-1042:hidden">
      ...
      <section className="relative z-10 mt-[-32px] max-744:mt-[-30px] mb-[8px] hidden max-1042:block max-744:hidden">
        <div className="w-full bg-white rounded-[32px] py-[20px]">
