...
const CTA = () => {
  return (
    <>
      {/* Desktop / 1440 */}
    <section 
        className="relative overflow-hidden mb-[8px] max-1042:hidden"
        style={{
      ...
      <section className="relative overflow-hidden mb-[8px] hidden max-1042:block max-744:hidden" style={{ backgroundColor: '#59AD3B', borderRadius: 32, paddingTop: 49, paddingBottom: 49 }}>
