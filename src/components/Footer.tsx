const Footer = () => {
  return (
    <>
      ...
      <footer className="bg-white h-[962px] box-border hidden max-744:flex flex-col gap-[40px] items-center pt-[60px] pb-[20px] px-[40px] rounded-tl-[16px] rounded-tr-[16px]">
