...
export default {
  ...
  theme: {
    extend: {
      screens: {
        // Брейкпоинты строго под макеты Figma: 1920 (base), 1042, 744, 375
        // Используем max-width, чтобы базовая верстка была 1920, а ниже — точные макеты.
        // max-1042 — на экранах ≤1042px показывается планшетный лейаут (чтобы на 13" ноутбуках ~1200px показывался десктоп)
