...
export default {
  ...
  theme: {
    extend: {
      screens: {
        // Брейкпоинты строго под макеты Figma: 1920 (base), 1440, 744, 375
        // Используем max-width, чтобы базовая верстка была 1920, а ниже — точные макеты.
        // Дополнительно: max-1200 — чтобы на любых ширинах <1200 включался tablet-лейаут (иначе desktop 1200px ломается на 8xx-11xx).
        // min-744 — включение планшетной навигации ровно с 744px (в Tailwind дефолтный md=768, нам нужно строго 744).
        'min-744': '744px',
        'max-1200': { max: '1200px' },
        'max-1440': { max: '1440px' },
        'max-1024': { max: '1024px' },
